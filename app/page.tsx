      ...
      <div className="relative mx-auto flex w-full flex-col gap-10 py-12">
        ...
        <section className="grid gap-6 lg:grid-cols-[1.5fr_0.5fr] p-4">
          <div className="space-y-6">
            <div className={`${surfaceClass} relative overflow-hidden p-8 shadow-[15px_20px_60px_rgba(3,7,12,0.8)]`}>
              <div className="absolute inset-x-1/4 top-0 h-32 rounded-full bg-nyembo-sky/20 blur-3xl" />
              ...
              <div className="relative mt-10 space-y-4">
                ...
                <h1 className="text-5xl font-black tracking-[0.2em] text-white/90 md:text-6xl">NYEMBOTECH</h1>
                <p className="text-white/80 md:text-lg">
                  Where African problem statements meet space-grade engineering. Platforms, AI agents and smart spaces for the next decade.
                </p>
              </div>

              <div className="mt-10 grid gap-4 sm:grid-cols-2">
                <button className={`${surfaceClass} rounded-[2rem] border border-white/20 bg-white/5 px-5 py-4 text-left text-white transition hover:border-white/40`}>
        ...
        <section className={`${surfaceClass} space-y-8 p-8`}>
