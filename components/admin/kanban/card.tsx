...
export function KanbanCard({ task }: KanbanCardProps) {
    ...
    return (
        <div ref={setNodeRef} style={style} {...attributes} {...listeners} className="h-full">
            <div className="h-full group cursor-grab active:cursor-grabbing hover-lift-neumo transition-all duration-300">
                <Card className="h-full bg-card/40 border-white/5 group-hover:border-nyembo-sky/30 shadow-neumo backdrop-blur-md">
